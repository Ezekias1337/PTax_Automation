...
function generateDelayNumber() {
    const amountToSleep = Math.floor(Math.random() * (45000 - 15000 + 1) + 15000);
    console.log("delay in ms", amountToSleep)
...
dataEntryNYTaxBills(['1-491-1201', '1-491-1202', '1-491-1203'])
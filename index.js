...
async function laCountyConfirmPayment(arrayOfParcels) {
    ...
    for (const item of arrayOfParcels) {
        ...
        try {
            ...
            await driver.findElement(By.xpath("/html/body/table/tbody/tr/td[1]/div/table/tbody/tr/td[2]/div/table[2]/tbody/tr[1]/td[2]/form/div[3]/input[1]"))
                .sendKeys(mapBook);
            await driver.findElement(By.xpath("/html/body/table/tbody/tr/td[1]/div/table/tbody/tr/td[2]/div/table[2]/tbody/tr[1]/td[2]/form/div[3]/input[2]"))
                .sendKeys(page);
            await driver.findElement(By.xpath("/html/body/table/tbody/tr/td[1]/div/table/tbody/tr/td[2]/div/table[2]/tbody/tr[1]/td[2]/form/div[3]/input[3]"))
                .sendKeys(parcel, Key.RETURN);

            await driver.findElement(By.xpath("/html/body/table/tbody/tr/td[1]/div/table/tbody/tr/td[2]/div/table[2]/tbody/tr[1]/td[2]/form/table/tbody/tr/td[1]/input"))
                .click();
            const paidAmount = await driver.findElement(By.xpath("/html/body/table/tbody/tr/td[1]/div/table/tbody/tr/td[2]/div/div/table/tbody/tr[5]/td[2]"))
                .getAttribute("innerText");
            ...
            await driver.findElement(By.xpath("/html/body/table/tbody/tr/td[1]/div/table/tbody/tr/td[2]/div/div/input"))
                .click();
            await driver.findElement(By.xpath("/html/body/table/tbody/tr/td[1]/div/table/tbody/tr/td[2]/div/div[1]/div[2]/a/div/span"))
                .click();
        } catch (error) {
            console.log(error)
